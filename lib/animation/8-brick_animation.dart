        ...
        child: Row(
          ...
          children: <Widget>[
            new AnimatedBrick(
              ...
              container: _animationController,
...
class AnimatedBrick extends AnimatedWidget {
  ...
  AnimatedBrick({
    ...
    this.marginLeft,
    this.isClockWise,
  }) : super(key: key, listenable: container);
...
class BrickWidget extends StatelessWidget {
  ...
  const BrickWidget({Key key, this.marginLeft = 15.0}) : super(key: key);
